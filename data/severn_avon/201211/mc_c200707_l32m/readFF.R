...
FF$m <- RF$m                                                                  # number of members in the ensemble
FF$nproc <- RF$np                                                             # number of processors [coworkers] for ensemble model execution in HPC  (normally ~30)
